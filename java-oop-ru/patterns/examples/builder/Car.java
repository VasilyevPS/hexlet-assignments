...
public class Car {
    ...
    public final class Builder {
        ...
        public Builder setDoorsAmount(int carDorsAmount) {
            this.doorsAmount = carDorsAmount;
            return this;
        }

        public Builder setEnginePower(double carEnginePower) {
            this.enginePower = carEnginePower;
            return this;
        }
