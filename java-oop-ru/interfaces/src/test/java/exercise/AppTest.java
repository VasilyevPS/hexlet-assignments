...
class AppTest {
    ...
    void testReversedSequence2() {
        CharSequence text = new ReversedSequence("zyx1234");
        assertThat(text.toString()).isEqualTo("4321xyz");
        assertThat(text.charAt(1)).isEqualTo('3');
        assertThat(text.length()).isEqualTo(7);
        assertThat(text.subSequence(3, 5).toString()).isEqualTo("1x");
    }
    ...
    void testReversedSequence3() {
        ...
        assertThat(text.charAt(1)).isEqualTo('\u0000');
        assertThat(text.length()).isEqualTo(0);
        assertThat(text.subSequence(1, 4).toString()).isEqualTo("");
    }
    // END
}
